...
questions_list.append(Question('Какого цвета нет в флаге России', 'Зелёный', 'Белый', "Синий", "Красный"))
questions_list.append(Question('Национальная хижина якетов', 'Ураса', 'Юрта', "Иглу", "Хата"))
...
rbtn_1 = QRadioButton('Вопрос1')
rbtn_2 = QRadioButton('Вопрос2')
rbtn_3 = QRadioButton('Вопрос3')
rbtn_4 = QRadioButton('Вопрос4')
